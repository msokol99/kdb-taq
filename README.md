...
kdb-taq is a tool for processing and analyzing historical NYSE Daily TAQ data using kdb+/q. This repository contains scripts and utilities to parse, load, and query TAQ datasets efficiently.
